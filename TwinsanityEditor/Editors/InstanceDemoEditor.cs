...
{
    public partial class InstanceDemoEditor : Form
    {
        ...
        public InstanceDemoEditor(SectionController c)
        {
            File = c.MainFile;
            controller = c;
            InitializeComponent();
            Text = $"InstanceDemo Editor (Section {c.Data.Parent.ID})";
            PopulateList();
            comboBox1.TextChanged += comboBox1_TextChanged;
            FormClosed += InstanceDemoEditor_FormClosed;
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            File.SelectItem((InstanceDemo)controller.Data.Records[listBox1.SelectedIndex]);
            ins = (InstanceDemo)File.SelectedItem;
        ...
        private string GenTextForList(InstanceDemo instance)
        {
        ...
        private void removeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < controller.Data.Records.Count; ++i)
            {
                ...
                InstanceDemo new_ins = (InstanceDemo)controller.Data.Records[i];
                if (new_ins.ID != i)
                {
        ...
        private void btnEditInstanceFlags_Click(object sender, EventArgs e)
        {
            ...
            {
                flagsEditor = new InstanceDemoFlagsEditor(ins, numFlags);
            }
            flagsEditor.Show();
        }
