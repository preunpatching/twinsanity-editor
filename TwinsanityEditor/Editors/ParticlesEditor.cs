...
namespace TwinsanityEditor
{
    ...
    {
        private readonly ParticleDataController controller;
        private ParticleData.ParticleSystemDefinition CurDef;
        private ParticleData.ParticleSystemInstance CurInst;
        ...
        private void PopulateList()
        {
            ...
            int id = 0;
            foreach (ParticleData.ParticleSystemInstance i in controller.Data.ParticleInstances)
            {
                _ = listBox1.Items.Add($"{id:000}: {i.Name}");
                id++;
            }
            listBox2.Items.Clear();
            id = 0;
            foreach (ParticleData.ParticleSystemDefinition i in controller.Data.ParticleTypes)
            {
                _ = listBox2.Items.Add($"{id:000}: {i.Name}");
                id++;
            }
        }
        ...
        private void listBox1_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            numericUpDown14.Value = CurInst.GravityRotX;
            numericUpDown15.Value = CurInst.GravityRotY;
            numericUpDown18.Value = CurInst.EmitRotX;
            numericUpDown19.Value = CurInst.EmitRotY;
            numericUpDown1.Value = CurInst.UnkShort5;
            numericUpDown2.Value = CurInst.Offset;
            numericUpDown3.Value = CurInst.SwitchType;
            numericUpDown4.Value = CurInst.SwitchID;
            numericUpDown5.Value = (decimal)CurInst.SwitchValue;
            numericUpDown6.Value = CurInst.UnkShort6;
            numericUpDown7.Value = CurInst.UnkShort7;
            numericUpDown8.Value = (decimal)CurInst.PlaneOffset;
            numericUpDown9.Value = (decimal)CurInst.BounceFactor;
            numericUpDown13.Value = CurInst.GroupID;
        ...
        {
            if (controller.Data.ParticleInstances.Count == 255)
            {
                return;
            }

            string name = "Unnamed";
            if (controller.Data.ParticleTypes.Count != 0)
            {
            ...
            {
                name = controller.Data.ParticleTypes[listBox2.SelectedIndex].Name;
            }

            Pos targetPos = new Pos(0, 0, 0, 1);
            targetPos = File.RMViewer_GetPos(targetPos);
            ParticleData.ParticleSystemInstance inst = new ParticleData.ParticleSystemInstance()
            {
                Name = name,
                Position = targetPos,
                SwitchID = -1,
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            string name = "Unnamed";
            ParticleData.ParticleSystemDefinition partdef = new ParticleData.ParticleSystemDefinition()
            {
                Name = name,
                GenRate = 1,
                MaxParticleCount = 10,
        ...
        private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            numericUpDown16.Value = CurDef.GenRate;
            numericUpDown17.Value = CurDef.MaxParticleCount;
            numericUpDown20.Value = CurDef.UnkUShort3;
            numericUpDown21.Value = CurDef.Emitter_OverTime;
            numericUpDown22.Value = CurDef.Emitter_OverTimeRandom;
            numericUpDown23.Value = CurDef.Emitter_OffTime;
            numericUpDown24.Value = CurDef.Emitter_OffTimeRandom;
            comboBox1.SelectedIndex = (int)CurDef.GSort;
            numericUpDown25.Value = CurDef.UnkByte3;
            comboBox2.SelectedIndex = (int)CurDef.TextureFilter;
            numericUpDown26.Value = CurDef.UnkByte5;
            ...
            numericUpDown89.Value = CurDef.UnkUShort8;
            numericUpDown88.Value = CurDef.UnkByte6;
            numericUpDown54.Value = CurDef.UnkByte7;
            ...
            numericUpDown100.Value = CurDef.TextureStartX >= 524288f
                ? (decimal)(CurDef.TextureStartX - 524288f)
                : CurDef.TextureStartX >= 262144f ? (decimal)(CurDef.TextureStartX - 262144f) : (decimal)CurDef.TextureStartX;

            numericUpDown101.Value = CurDef.TextureStartY >= 524288f
                ? (decimal)(CurDef.TextureStartY - 524288f)
                : CurDef.TextureStartY >= 262144f ? (decimal)(CurDef.TextureStartY - 262144f) : (decimal)CurDef.TextureStartY;

            numericUpDown102.Value = CurDef.TextureEndX >= 524288f
                ? (decimal)(CurDef.TextureEndX - 524288f)
                : CurDef.TextureEndX >= 262144f ? (decimal)(CurDef.TextureEndX - 262144f) : (decimal)CurDef.TextureEndX;

            numericUpDown103.Value = CurDef.TextureEndY >= 524288f
                ? (decimal)(CurDef.TextureEndY - 524288f)
                : CurDef.TextureEndY >= 262144f ? (decimal)(CurDef.TextureEndY - 262144f) : (decimal)CurDef.TextureEndY;

            numericUpDown104.Value = CurDef.CollisionNumSpheres;
            ...
            numericUpDown107.Value = CurDef.ParticleGhostsNum;
            numericUpDown108.Value = CurDef.StarRadialPoints;
            ...
            numericUpDown112.Value = CurDef.TexturePage;
        ...
        private void UpdateTexFiltering()
        {
            ignore_value_change = true;
        ...
        private void numericUpDown100_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurDef.TextureStartX = CurDef.TextureStartX >= 524288f
                ? (float)numericUpDown100.Value + 524288f
                : CurDef.TextureStartX >= 262144f ? (float)numericUpDown100.Value + 262144f : (float)numericUpDown100.Value;
        }
        ...
        private void numericUpDown101_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurDef.TextureStartY = CurDef.TextureStartY >= 524288f
                ? (float)numericUpDown101.Value + 524288f
                : CurDef.TextureStartY >= 262144f ? (float)numericUpDown101.Value + 262144f : (float)numericUpDown101.Value;
        }
        ...
        private void numericUpDown102_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurDef.TextureEndX = CurDef.TextureEndX >= 524288f
                ? (float)numericUpDown102.Value + 524288f
                : CurDef.TextureEndX >= 262144f ? (float)numericUpDown102.Value + 262144f : (float)numericUpDown102.Value;
        }
        ...
        private void numericUpDown103_ValueChanged(object sender, EventArgs e)
        {
            ...
            CurDef.TextureEndY = CurDef.TextureEndY >= 524288f
                ? (float)numericUpDown103.Value + 524288f
                : CurDef.TextureEndY >= 262144f ? (float)numericUpDown103.Value + 262144f : (float)numericUpDown103.Value;
        }
