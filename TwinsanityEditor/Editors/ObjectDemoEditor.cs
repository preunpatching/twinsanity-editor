...
namespace TwinsanityEditor
{
    public partial class ObjectDemoEditor : Form
    {
        ...
        private string GenTextForList(GameObjectDemo gameObject)
        {
            return $"ID {gameObject.ID} {(gameObject.Name == string.Empty ? string.Empty : $" - {gameObject.Name}")}";
        }

        private void ObjectDemoEditor_Load(object sender, EventArgs e)
        {
        ...
        private void objectList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                File.SelectItem((GameObjectDemo)controller.Data.Records[objectList.SelectedIndex]);
                gameObject = (GameObjectDemo)File.SelectedItem;
                if (flagsEditor != null)
                {
        ...
        private void buttonEditFlags_Click(object sender, EventArgs e)
        {
            ...
            {
                flagsEditor = new InstanceDemoFlagsEditor(gameObject, instFlagsBox);
            }
            flagsEditor.Show();
        }
