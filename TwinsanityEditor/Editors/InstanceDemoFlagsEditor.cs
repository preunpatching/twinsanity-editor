...
{
    public partial class InstanceDemoFlagsEditor : Form
    {
        ...
        public InstanceDemoFlagsEditor(InstanceDemo instance, NumericUpDown flagscontrol)
        {
            InitializeComponent();
        ...
        public InstanceDemoFlagsEditor(GameObjectDemo gobject, NumericUpDown flagscontrol)
        {
            InitializeComponent();
            this.flagscontrol = flagscontrol;
