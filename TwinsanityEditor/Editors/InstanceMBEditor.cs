...
namespace TwinsanityEditor
{
    public partial class InstanceMBEditor : Form
    {
        ...
        private void PopulateList()
        {
            ...
            foreach (InstanceMB i in controller.Data.Records)
            {
                listBox1.Items.Add(GenTextForList(i));
            }
            listBox1.EndUpdate();
            comboBox1.Items.Clear();
            var s_dic = new SortedDictionary<uint, int>(FileData.GetItem<TwinsSection>(11).GetItem<TwinsSection>(0).RecordIDs);
            foreach (var i in s_dic)
            {
                string obj_name = "Unknown";
                if (Enum.IsDefined(typeof(DefaultEnums.ObjectID_MB), (ushort)i.Key))
                {
                    obj_name = (DefaultEnums.ObjectID_MB)i.Key + "";
                }
        ...
        private void addToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            InstanceMB new_ins = new InstanceMB { ID = id, RefList = -1, ScriptID = -1, Pos = new Pos(0, 0, 0, 1), SomeNum1 = 10, SomeNum2 = 10, SomeNum3 = 10, Flags = 0x1CE,
        ...
        private void removeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < controller.Data.Records.Count; ++i)
            {
                ...
                InstanceMB new_ins = (InstanceMB)controller.Data.Records[i];
                if (new_ins.ID != i)
                {
        ...
        private void duplicateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            InstanceMB new_ins = new InstanceMB
            {
                ID = id,
                RefList = -1,
                ScriptID = -1,
        ...
        private void tabPage1_Enter(object sender, EventArgs e)
        {
            ...
            string obj_name = "Unknown";
            if (Enum.IsDefined(typeof(DefaultEnums.ObjectID_MB), (ushort)ins.ObjectID))
            {
                obj_name = (DefaultEnums.ObjectID_MB)ins.ObjectID + "";
            }
