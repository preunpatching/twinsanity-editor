...
namespace TwinsanityEditor
{
    public partial class InstanceMBEditor : Form
    {
        ...
        private readonly InstanceFlagsEditor flagsEditor;
        ...
        private void PopulateList()
        {
            ...
            SortedDictionary<uint, int> s_dic = new SortedDictionary<uint, int>(FileData.GetItem<TwinsSection>(11).GetItem<TwinsSection>(0).RecordIDs);
        ...
        private void tabPage1_Enter(object sender, EventArgs e)
        {
            ...
            string obj_name = "Unknown";
            if (Enum.IsDefined(typeof(DefaultEnums.ObjectID_MB), ins.ObjectID))
            {
