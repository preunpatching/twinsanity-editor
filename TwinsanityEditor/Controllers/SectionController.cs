    ...
    public class SectionController : Controller
    {
        ...
        public SectionController(MainForm topform, TwinsSection item) : base (topform)
        {
            ...
            if (item is TwinsFile f)
            {
                ...
                {
                    AddMenu("Add remaining instance sections", Menu_FileFillInstanceSectionsDemo);
                    AddMenu("Import object package (RM2)", Menu_ImportPackageDemo);
                }
        ...
        private void Menu_AddNew()
        {
            ...
            switch (Data.Type)
            {
                ...
                case SectionType.ObjectDemo: newItem = new GameObjectDemo(); break;
                ...
                case SectionType.ObjectInstanceDemo: newItem = new InstanceDemo(); break;
                ...
                case SectionType.CameraDemo: newItem = new Camera(); break;
        ...
        private void Menu_FileFillInstanceSectionsDemo()
        {
            for (uint i = 0; i <= 7; ++i)
            {
                if (!Data.ContainsItem(i))
        ...
        public void Menu_ImportPackageDemo()
        {
            using (OpenFileDialog ofd = new OpenFileDialog
            {
                InitialDirectory = Settings.Default.ChunkFilePath,
                Filter = "Demo RM2 file|*.rm2",
                FilterIndex = LastFilterIndex,
            })
            {
                ofd.FilterIndex = LastFilterIndex;
        ...
        private void Menu_ReOrderByID_Asc()
        {
            ...
            if (Data.Type == SectionType.ObjectInstanceDemo)
            {
                MainFile.CloseEditor(Editors.InstanceDemo, (int)Data.Parent.ID);
            }
