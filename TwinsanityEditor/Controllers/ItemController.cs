    ...
    public class ItemController : Controller
    {
        ...
        private void Menu_ReplaceItem()
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                else if (Data is InstanceDemo instanced)
                {
                    MainFile.CloseEditor(Editors.InstanceDemo, (int)Data.Parent.Parent.ID);
                    instanced.Load(reader, (int)reader.BaseStream.Length);
                }
